...
var (
	...
	startAtText = *flag.String("startAt", "", "start at(format: 2006-01-02T15:04:05)")
	endAtText   = *flag.String("endAt", "", "end at(format: 2006-01-02T15:04:05)")
)
